...
class Paintgui:
    ...
    def __init__(self):
        self.root = Tk()
        self.root.title('the paint clone')
        self.brush_width = 16
        ...
        self.color_btn = Button(self.btn_frame,text = 'Change_Color',command = self.change_color)
    ...
    def on_closing(self):
        answer = messagebox.askyesnocancel("Quit",'Do you really want to quit, with saving ?',parent = self.root)
